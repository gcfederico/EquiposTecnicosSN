...
{
    [Authorize]
    public class EquiposTerapeuticaController : EquiposBaseController
    {
        ...
        public override ActionResult Index()
        {
            ...
            var equipos = db.EquiposDeTerapeutica.ToList();
            return View(equipos);
        }
        ...
        {
            var model = new EquipoTerapeutica();
        ...
        public ActionResult Create(EquipoTerapeutica equipo)
        {
            
            if (ModelState.IsValid)//validaciones
            {
                db.EquiposDeTerapeutica.Add(equipo);
                db.SaveChanges();
        ...
        public ActionResult Edit(int? id)
        {
            ...
            var equipo = db.EquiposDeTerapeutica.Find(id);
            if (equipo == null)
            {
                return HttpNotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(EquipoTerapeutica equipo)
        {
        ...
        {
            EquipoTerapeutica equipo = db.EquiposDeTerapeutica.Find(id);
            db.EquiposDeTerapeutica.Remove(equipo);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
