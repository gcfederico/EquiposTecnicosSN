...
namespace EquiposTecnicosSN.Web.Controllers
{
    ...
    public class EquipamientosEdiliciosController : EquiposBaseController
    {
        ...
        {
            var model = new EquipamientoEdilicio();
        ...
        public ActionResult Create(EquipamientoEdilicio equipo)
        {
            ...
            {
                db.EquipamientosEdilicios.Add(equipo);
                db.SaveChanges();
        ...
        public ActionResult Edit(int? id)
        {
            ...
            var equipo = db.EquipamientosEdilicios.Find(id);
            if (equipo == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            db.EquipamientosEdilicios.Remove(equipo);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
