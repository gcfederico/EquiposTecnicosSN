...
{
    [Authorize]
    public class EquiposOtrosController : EquiposBaseController
    {
        ...
        public override ActionResult Index()
        {
            ...
            var equipos = db.EquiposOtros.ToList();
            return View(equipos);
        }
        ...
        public ActionResult Create(EquipoOtro equipo)
        {
            
            if (ModelState.IsValid)//validaciones
            {
                db.EquiposOtros.Add(equipo);
                db.SaveChanges();
        ...
        public ActionResult Edit(int? id)
        {
            ...
            var equipo = db.EquiposOtros.Find(id);
            if (equipo == null)
            {
                return HttpNotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(EquipoOtro equipo)
        {
        ...
        {
            EquipoOtro equipo = db.EquiposOtros.Find(id);
            db.EquiposOtros.Remove(equipo);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
