...
{
    [Authorize]
    public class EquiposMonitoreoController : EquiposBaseController
    {
        ...
        public override ActionResult Index()
        {
            ...
            var equipos = db.EquiposDeMonitoreo.ToList();
            return View(equipos);
        }
        ...
        public ActionResult Edit(int? id)
        {
            ...
            var equipo = db.EquiposDeMonitoreo.Find(id);
            if (equipo == null)
            {
                return HttpNotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(EquipoMonitoreo equipo)
        {
        ...
        {
            EquipoMonitoreo equipo = db.EquiposDeMonitoreo.Find(id);
            db.EquiposDeMonitoreo.Remove(equipo);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
