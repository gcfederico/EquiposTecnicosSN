...
namespace EquiposTecnicosSN.Web.Controllers
{
    ...
    public class EquiposSoporteDeVidaController : EquiposBaseController
    {
        ...
        public override ActionResult Index()
        {
            ...
            var equipos = db.EquiposDeSoporteDeVida.ToList();
            return View(equipos);
        }
        ...
        {
            var model = new EquipoSoporteDeVida();
        ...
        public ActionResult Create(EquipoSoporteDeVida equipo)
        {
            
            if (ModelState.IsValid)//validaciones
            {
                db.EquiposDeSoporteDeVida.Add(equipo);
                db.SaveChanges();
        ...
        public ActionResult Edit(int? id)
        {
            ...
            var equipo = db.EquiposDeSoporteDeVida.Find(id);
            if (equipo == null)
            {
                return HttpNotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(EquipoSoporteDeVida equipo)
        {
        ...
        {
            EquipoSoporteDeVida equipo = db.EquiposDeSoporteDeVida.Find(id);
            db.EquiposDeSoporteDeVida.Remove(equipo);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
